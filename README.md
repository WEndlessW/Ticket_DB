...
##Jak projekt spustit?
Otevřete **MySQL Workbench**, vytvořte databázi *(např. tickets_db)*, spusťte **SQL skript**. A databáze by měla být plně připravena k použití. [Go to parent folder README](SQL_Databáze_Ticket_DB/ticket_db.sql)
